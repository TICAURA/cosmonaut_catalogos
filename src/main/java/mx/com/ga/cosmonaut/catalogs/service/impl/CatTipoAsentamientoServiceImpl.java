...
import mx.com.ga.cosmonaut.common.repository.catalogo.negocio.CatTipoAsentamientoRepository;
...
public class CatTipoAsentamientoServiceImpl implements CatTipoAsentamientoService {
    ...
    public RespuestaGenerica findByEsActivo(Boolean activo) throws ServiceException {
        try {
            respuestaGenerica.setDatos(catTipoAsentamientoRepository.findByEsActivoOrderByDtipoAsenta(activo));
