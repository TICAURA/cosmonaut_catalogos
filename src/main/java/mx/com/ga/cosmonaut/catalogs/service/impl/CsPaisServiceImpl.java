...
import mx.com.ga.cosmonaut.common.repository.catalogo.sat.CsPaisRepository;
...
@Singleton
public class CsPaisServiceImpl implements CsPaisService {

    @Inject
    private CsPaisRepository csPaisRepository;
    private RespuestaGenerica respuestaGenerica = new RespuestaGenerica();

    @Override
    public RespuestaGenerica findByEsActivo(Boolean activo) throws ServiceException {
        try {
            respuestaGenerica.setDatos(csPaisRepository.findByEsActivo(activo));
