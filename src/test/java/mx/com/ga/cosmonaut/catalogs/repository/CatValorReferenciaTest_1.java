...
@MicronautTest
public class CatValorReferenciaTest_1 {

	private static final Logger LOG = LoggerFactory.getLogger(CatValorReferenciaTest_1.class);
        
    @Inject
    @Client("/catalogo/valorReferencia")
