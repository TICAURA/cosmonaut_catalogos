...
@MicronautTest
public class CsPeriodicidadPagoTest_1 {

	private static final Logger LOG = LoggerFactory.getLogger(CsPeriodicidadPagoTest_1.class);
        
    @Inject
    @Client("/catalogo/csPeriodicidadPago")
