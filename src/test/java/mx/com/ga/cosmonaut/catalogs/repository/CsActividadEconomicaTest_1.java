...
@MicronautTest
public class CsActividadEconomicaTest_1 {
    private static final Logger LOG = LoggerFactory.getLogger(CsActividadEconomicaTest_1.class);

    @Inject
    @Client("/catalogo/csActividadEconomica")
