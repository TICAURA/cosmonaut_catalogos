...
@MicronautTest
public class CsTipoRegimenContratacionTest_1 {

	private static final Logger LOG = LoggerFactory.getLogger(CsTipoRegimenContratacionTest_1.class);
        
    @Inject
    @Client("/catalogo/csTipoRegimenContratacion")
