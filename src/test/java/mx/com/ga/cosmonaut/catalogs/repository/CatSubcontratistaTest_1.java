...
@MicronautTest
public class CatSubcontratistaTest_1 {

	private static final Logger LOG = LoggerFactory.getLogger(CatSubcontratistaTest_1.class);
        
    @Inject
    @Client("/catalogo/subcontratista")
