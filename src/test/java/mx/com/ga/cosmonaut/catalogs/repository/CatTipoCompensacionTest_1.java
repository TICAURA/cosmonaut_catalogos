...
@MicronautTest
public class CatTipoCompensacionTest_1 {

	private static final Logger LOG = LoggerFactory.getLogger(CatTipoCompensacionTest_1.class);
        
    @Inject
    @Client("/catalogo/tipoCompensacion")
