...
@MicronautTest
public class CatTipoPreferenciaTest_1 {

	private static final Logger LOG = LoggerFactory.getLogger(CatTipoPreferenciaTest_1.class);
        
    @Inject
    @Client("/catalogo/tipoPreferencia")
