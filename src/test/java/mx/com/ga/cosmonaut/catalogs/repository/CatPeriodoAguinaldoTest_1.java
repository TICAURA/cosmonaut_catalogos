...
@MicronautTest
public class CatPeriodoAguinaldoTest_1 {

	private static final Logger LOG = LoggerFactory.getLogger(CatPeriodoAguinaldoTest_1.class);
        
    @Inject
    @Client("/catalogo/catPeriodoAguinaldo")
